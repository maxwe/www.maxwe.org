...
public class ZipEncrypt_aes {
	...
	public static void main(String args[]) throws Exception {
		...
		new ZipEncrypt_aes().encryptZip("e:/com", "e:/comXXX/page.zip", "e:/comXXX/public.key");

		System.out.println(System.currentTimeMillis() - a);
		a = System.currentTimeMillis();

		new ZipEncrypt_aes().decryptUnzip("e:/comXXX/page.zip", "e:/comxxx", "e:/comXXX/public.key");
		System.out.println(System.currentTimeMillis() - a);
	}
}
